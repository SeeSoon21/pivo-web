...
public class MailThread extends Thread{
    ...
    private void init() {
        //session creator – конфигурирование почтовой сессии
        //мы получаем готовый объект, в котором указаны все свойства сессии(порт, нейм, сокет и тд)
        Session mailSession = (new SessionCreator(properties)).createSession();
        mailSession.setDebug(true);
        //mimeStyle(наследник Message) – это объект, который заполняется аттрибутами
